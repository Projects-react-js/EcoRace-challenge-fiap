...
export default function Manual({ sectionStyle, subtitleStyle, title, links }){


    const textAndStyleSubtitle1 = [
        {
    ...
    const textAndStyleSubtitle2 = [
        {
        style: "text-white font-roboto md:text-xl text-sm pr-5",
        text: "Todas as peças e links para montar o carrinho dos seus sonhos. Comece agora!",
        },
    ]

    const styleOfSections = [
        {
        style: 'flex flex-col relative w-full min-w-56 bg-black sm:px-32 sm:py-40 gap-20 px-10 py-20'
        }
    ]
        ...
        <>
            <Sections forSections={styleOfSections}>
                <div className="flex flex-col items-start">
                    <Subtitle forSubtitle={textAndStyleSubtitle1}/>
                    <Title forTitle={titleManual}/>
                    <Subtitle forSubtitle={textAndStyleSubtitle2}/>
                </div>
                ...
                <div className="flex flex-col gap-5 bg-slate-200 rounded-3xl p-10">
                    <h3 className="text-black text-start sm:text-center sm:text-lg text-sm">Agora que você já tem tudo, confira os locais mais próximos de você para fazer a impressão 3D. </h3>
